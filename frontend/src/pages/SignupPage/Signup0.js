...
import { setAgreed } from "../../store/signupSlice";
...
export default function Signup0() {
  ...
  return (
    <form id={styles.termsContainer} onSubmit={handleSubmit}>
      <div className="d-flex align-items-end">
        <h3>회원가입 동의</h3>
        <p style={{ color: "#034bb9", fontWeight: "bold", fontSize: "1rem" }}>
          &nbsp;(필수)
        </p>
      </div>
      <Terms />
      <div className="mt-2 mb-5 form-check">
        ...
        />
        <label className="form-check-label" htmlFor="agreedCheck">
          약관에 동의합니다.
        </label>
      </div>
      <div className="d-flex justify-content-center">
        <button type="submit" className={"btn me-2 " + styles.agreed_btn}>
          계속하기
        </button>
        <button type="button" className="btn btn-light ms-2" onClick={disagreed}>
          돌아가기
        </button>
      </div>
    </form>
...
function Terms() {
  return (
    <div className={styles.scrollable_div}>
      <p>
        <strong>&lt; 언오피셜 &gt;</strong> (
        <a href="https://unofficial.kr">'https://unofficial.kr'</a>이하
        '언오피셜')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의
        개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수
        있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
      </p>
      <p>○ 이 개인정보처리방침은 2023년 8월 8부터 적용됩니다.</p>
      <br />
      <br />
      <h6>제1조(개인정보의 처리 목적)</h6>
      <p style={{ fontWeight: "bold" }}>
        {"<"} 언오피셜 {">"}('https://unofficial.kr'이하 '언오피셜')은(는)
      ...
      <br />
      <p>2. 민원사무 처리</p>
      <p>민원사항 확인, 처리결과 통보 목적으로 개인정보를 처리합니다.</p>
      <br />
      <p>3. 재화 또는 서비스 제공</p>
      ...
      <p>
        ① {"<"} 언오피셜 {">"}은(는) 법령에 따른 개인정보 보유·이용기간 또는
      ...
      <br />
      <h6>제3조(처리하는 개인정보의 항목)</h6>
      <p>
        ① {"<"} 언오피셜 {">"}은(는) 다음의 개인정보 항목을 처리하고 있습니다.
      </p>
      <ul>
        <li>
          1{"<"} 홈페이지 회원가입 및 관리 {">"}
        </li>
        <li>필수항목 : 비밀번호, 이메일, 서비스 이용 기록</li>
        <li>선택항목 :</li>
      </ul>
      <br />
      <h6>제4조(개인정보의 파기절차 및 파기방법)</h6>
      <p>
        ① {"<"} 언오피셜 {">"} 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
      ...
      <p>1. 파기절차</p>
      <p>
        {"<"} 언오피셜 {">"} 은(는) 파기 사유가 발생한 개인정보를 선정하고,{" "}
        {"<"} 언오피셜 {">"} 의 개인정보 보호책임자의 승인을 받아 개인정보를
        파기합니다.
      </p>
      <p>2. 파기방법</p>
      <p>
      ...
      <br />
      <h6>제5조(미이용자의 개인정보 파기 등에 관한 조치)</h6>
      <p>
      ...
      <p>
        ...
        개인정보 항목을 이메일, 문자 등 이용자에게 통지 가능한 방법으로 알리고
        있습니다.
      </p>
      <p>
      ...
      <p>
        ① 정보주체는 언오피셜에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
        요구 등의 권리를 행사할 수 있습니다.
      </p>
      <p>
        ② 제1항에 따른 권리 행사는언오피셜에 대해 「개인정보 보호법」 시행령
        제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
        있으며 언오피셜은(는) 이에 대해 지체 없이 조치하겠습니다.
      </p>
      <p>
      ...
      <p>
        ⑥ 언오피셜은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를
        확인합니다.
      </p>
      <br />
      <h6>제7조(개인정보의 안전성 확보조치에 관한 사항)</h6>
      <p>
        {"<"} 언오피셜 {">"}은(는) 개인정보의 안전성 확보를 위해 다음과 같은
        조치를 취하고 있습니다.
      </p>
      ...
      <p>5. 해킹 등에 대비한 기술적 대책</p>
      <p>
        {"<"}언오피셜{">"}('언오피셜')은 해킹이나 컴퓨터 바이러스 등에 의한
      ...
      <p>
        ① 언오피셜 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
      ...
      <p>
        {"<"}인터넷{">"}나. 쿠키의 설치•운영 및 거부 : 웹브라우저 상단의 도구
        {">"}인터넷{">"}인터넷 옵션{">"}개인정보 메뉴의 옵션 설정을 통해 쿠키
        저장을 거부 할 수 있습니다.
      </p>
      <p>
      ...
      <br />
      <h6>제9조 (개인정보 보호책임자에 관한 사항)</h6>
      <p>
        ① 언오피셜 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
      ...
      <ul>
        ...
        <li>직책 :대표</li>
        <li>직급 :팀장</li>
        <li>연락처 :010-1234-5678, jsgoo2001@naver.com,</li>
      </ul>
      ...
      <p>
        ② 정보주체께서는 언오피셜 의 서비스(또는 사업)을 이용하시면서 발생한
        모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 언오피셜 은(는)
        정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
      </p>
      <br />
      <h6>제10조(개인정보의 열람청구를 접수·처리하는 부서)</h6>
      <h6>
        정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의
        부서에 할 수 있습니다.
        {"<"} 언오피셜 {">"}은(는) 정보주체의 개인정보 열람청구가 신속하게
        처리되도록 노력하겠습니다.
      </h6>
      <br />
      ...
      <br />
      <h6>제11조(정보주체의 권익침해에 대한 구제방법)</h6>
      <p>
